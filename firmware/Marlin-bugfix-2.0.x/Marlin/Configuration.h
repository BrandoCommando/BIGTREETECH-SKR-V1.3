...
#define STRING_CONFIG_H_AUTHOR "(Brandon Bowles, SKR-V1.3)" // Who made the changes.
...
#define HOTEND_OFFSET_Y { 0.0, -47.00 }  // (mm) relative Y-offset for each nozzle
...
#define Z_MIN_ENDSTOP_INVERTING Z_MIN_PROBE_ENDSTOP_INVERTING // Set to true to invert the logic of the endstop.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 80, 394, 409, 600 }
...
#define Z_SERVO_ANGLES { 20, 140 } // Z Servo Deploy and Stow angles
 ...
 *   (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 40 //-38  // X offset: -left  +right  [of the nozzle]
#define Y_PROBE_OFFSET_FROM_EXTRUDER 28 //-27  // Y offset: -front +behind [the nozzle]
...
//#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_BKGD_COLOR { 0, 255, 0, 0 }
#endif
